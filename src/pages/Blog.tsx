...
const Blog = () => {
  ...
  useEffect(() => {
    // Handle hash-based smooth scrolling
    if (location.hash) {
      ...
      // Scroll to top only if no hash is present
      window.scrollTo(0, 0);
    }
  }, [location]);
  ...
  return (
    <main>
      <Helmet>
        <title>
          Latest Articles on Data Science, AI, and Analytics | RISE Blog
        </title>
        <meta
          name="description"
          content="RISE MEAL System simplifies monitoring and evaluation, delivering real-time insights to empower humanitarian aid organizations."
        />
      </Helmet>
      ...
      {loading ? (
        ...
        <div className="mx-auto max-w-[150rem] px-[2rem] pb-[4rem] sm:px-[4rem]">
                ...
                {layout === "grid" && (
                  <div className="grid grid-cols-1 gap-x-[3.2rem] gap-y-[6.4rem] md:grid-cols-2 lg:grid-cols-4">
                    {currentPosts.map((post) => (
                      <NavLink
                        to={`/blog/${post.slug}`} // Adjust based on your routing
                        className="group"
                        key={post.id}
                    ...
                    {currentPosts.map((post) => (
                      ...
                      >
                        ...
                        <div className="w-full">
                          ...
                          <NavLink
                            to={`/blog/${post.slug}`} // Adjust based on your routing // Adjust based on your routing
