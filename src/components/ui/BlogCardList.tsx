...
const BlogCardList = ({ post }: BlogCardListProps) => {
  ...
  return (
    <div className="group flex gap-[4rem] border-b border-[#DCE0E2] pb-[4rem] hover:border-[#006BFF]">
      <NavLink
        to={`/blog/${post.slug}`}
      ...
      <div className="flex flex-col justify-between">
        <ul className="flex items-center gap-[.8rem] text-[1.2rem] leading-[2rem] font-medium tracking-[.3px] uppercase">
          ...
          <li>
            <NavLink to="" className="text-[#006BFF] hover:underline">
              {category}
            </NavLink>
          </li>
        ...
        >
          ...
          <p
            className="line-clamp-3 max-w-[50rem] text-[2rem] leading-[2.8rem]"
        ...
        <div className="text-[1.2rem] leading-[2rem] tracking-[.3px]">
          <span>By</span>{" "}
          <a href="" className="text-[#006BFF] capitalize hover:underline">
            {author}
          </a>
        </div>
      </div>
