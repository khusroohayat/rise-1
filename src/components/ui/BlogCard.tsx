...
const BlogCard = ({ post }: BlogCardProps) => {
  ...
  return (
    ...
    >
      <div>
        <div className="h-[20rem] w-full overflow-hidden md:h-[12rem] lg:h-[18rem]">
          {featuredImage && (
            <img
              src={featuredImage}
        ...
        <div className="border-l-[4px] border-[#006BFF] bg-[#EEEDE9] p-[.8rem] text-[1.4rem] leading-[1.2rem] font-medium uppercase transition-all duration-200 group-hover:border-l-[8px] md:px-[1.6rem] md:py-[1.2rem]">
          <span>{category}</span>
        </div>
      </div>
