...
const SubscribeForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post("https://www.RISE.org/subscribe.php", {
        email,
        country,
      });
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col">
      ...
      <p className="my-[2rem] text-[1.2rem] leading-[1.44rem]">
        ...
        communications, and I agree to RISE processing my personal data in
      ...
      <Button className="h-[4rem]">Submit</Button>
