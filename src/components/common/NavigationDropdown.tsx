...
const NavigationDropdown = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute left-[20rem] z-50 transition-all duration-300 ${
          activeDropdown
      ...
      >
        <div className="shadow-01 flex overflow-hidden rounded-[8px] bg-white">
          {/* Left Side */}
          <ul className="grid w-[65rem] grid-cols-2 gap-[2.4rem] overflow-y-auto p-[2rem]">
          ...
          {/* Right Side  */}
          <div className="flex w-[25rem] flex-col gap-[1rem] bg-[#E5E1DC] p-[1.6rem]">
