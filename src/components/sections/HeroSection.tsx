  ...
  return (
    <section className="px-[2rem] md:px-[4rem]">
      ...
      >
        ...
        >
          {[heroImg01, heroImg02, heroImg03].map((item, idx) => (
            <SwiperSlide key={idx} className="relative">
              ...
              <div className="absolute bottom-1/2 z-[10] w-full translate-y-1/2 px-[2rem] xl:bottom-[5rem] xl:translate-y-0 xl:px-[5rem]">
                          ...
                          <div className="size-[1.7rem] overflow-hidden">
                            <div className="flex -translate-x-full transform transition-transform duration-300 group-hover:translate-x-0">
                              <div className="flex size-full items-center justify-center">
                                <ArrowRight className="size-[1.7rem] stroke-2 text-[#006BFF]" />
                              </div>
